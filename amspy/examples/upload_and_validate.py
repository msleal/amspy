...
xml_path = "validate_mp4.xml"
job_definition = "Windows Azure Media Packager"
processor_id = "nb:mpid:UUID:a2f9afe9-7146-4882-a5f7-da4a85e06a93"
...
## create a media job
print ("\n015 >>> Creating a Media Job (task: validate mp4)")
with open(xml_path, mode='r') as file:
	xml_content = file.read()
response = amspy.create_media_job(access_token, "ValidateMP4", job_definition, processor_id, asset_id, xml_content)
if (response.status_code == 201):
	resjson = response.json()
	...
	print("POST Status.....................: " + str(response.status_code) + " - Media Job: '" + job_definition + "' Creation ERROR." + str(response.content))
