...
print ("\n015 >>> Getting the Media Processor for Motion Detection")
...
print ("\n016 >>> Creating a Motion Detection job to process the content")
...
print ("\n019 >>> Getting the Motion Detection Output Asset Id")
response = amspy.get_url(access_token, joboutputassets_uri, False)
if (response.status_code == 200):
	resjson = response.json()
	motion_asset_id = resjson['d']['results'][0]['Id']
	print("GET Status..............................: " + str(response.status_code))
	print("Motion Detection Output Asset Id..................: " + motion_asset_id)
else:
